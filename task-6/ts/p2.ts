...
const studentResult = (students) => {
  ...
  return {
    aPlusStudents: aPlus.toString(),
    aStudents: a.toString(),
    aMinusStudents: aMinus.toString(),
    bStudents: b.toString(),
    cStudents: c.toString(),
    dStudents: d.toString(),
  };
...
/* const addStudent = (stName, stRoll, banglaMark, mathMark, englishMark, religiousMark, scienceMark) => {
  const student = {
    key: stRoll,
    stName,
    banglaMark,
